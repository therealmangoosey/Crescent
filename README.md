...
```bash
curl -Lo crescent.tar.gz [https://github.com/exphost-net/Crescent/releases/latest/download/crescent.tar.gz](https://github.com/exphost-net/Crescent/releases/latest/download/crescent.tar.gz)
```
